...
# ----------------------------------------------------------------------
def load_original_results(path="output/alpaca.db"):
...
# ----------------------------------------------------------------------
def load_prediction_results(path="output/alpaca-pred.db"):
    conn = sqlite3.connect(path)
    cur = conn.cursor()
...
if __name__ == "__main__":
    ...
    pct_correct, pct_correct_5, pct_correct_10, pct_correct_15, pct_correct_20, pct_correct_25, med_runtime, avg_std = compute_metrics(original, predictions)

    plot_bars(
        "Percentage of Correct Predictions",
        "output/llama3.3_pred_percentages.png",
        pct_correct,
        "Percent Correct")

    plot_bars(
        "Percentage of Correct Predictions (within 5 tokens)",
        "output/llama3.3_pred_percentages_5.png",
        pct_correct_5,
        "Percent Correct (within 5 tokens)")

    plot_bars(
        "Percentage of Correct Predictions (within 10 tokens)",
        "output/llama3.3_pred_percentages_10.png",
        pct_correct_10,
        "Percent Correct (within 10 tokens)")

    plot_bars(
        "Percentage of Correct Predictions (within 15 tokens)",
        "output/llama3.3_pred_percentages_15.png",
        pct_correct_15,
        "Percent Correct (within 15 tokens)")

    plot_bars(
        "Percentage of Correct Predictions (within 20 tokens)",
        "output/llama3.3_pred_percentages_20.png",
        pct_correct_20,
        "Percent Correct (within 20 tokens)")

    plot_bars(
        "Percentage of Correct Predictions (within 25 tokens)",
        "output/llama3.3_pred_percentages_25.png",
        pct_correct_25,
        "Percent Correct (within 25 tokens)")

    plot_bars(
        "Median Runtime per Model",
        "output/llama3.3_pred_medians.png",
        med_runtime,
        "Median Runtime (s)")

    plot_bars(
        "Average Std Dev Across Runs per Prompt",
        "output/llama3.3_pred_stddev.png",
        avg_std,
        "Std Dev")
